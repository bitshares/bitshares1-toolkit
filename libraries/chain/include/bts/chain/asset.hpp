...
namespace bts { namespace chain {
   ...
   /**
    * @brief The price struct stores asset prices in the BitShares Toolkit system.
    *
    ...
    * normal.
    *
    * The assets within a price are labeled base and quote. Throughout the BitShares Toolkit code base, the convention used is
