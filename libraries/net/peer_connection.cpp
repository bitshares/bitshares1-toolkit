...
namespace bts { namespace net
  {
    ...
    {
      VERIFY_CORRECT_THREAD();
      return inventory_peer_advertised_to_us.size() > BTS_NET_MAX_INVENTORY_SIZE_IN_MINUTES * BTS_NET_MAX_TRX_PER_SECOND * 60;
    }
    ...
    bool peer_connection::is_inventory_advertised_to_us_list_full() const
    {
      ...
      return inventory_peer_advertised_to_us.size() >
        BTS_NET_MAX_INVENTORY_SIZE_IN_MINUTES * BTS_NET_MAX_TRX_PER_SECOND * 60 +
        (BTS_NET_MAX_INVENTORY_SIZE_IN_MINUTES + 1) * 60 / BTS_MAX_BLOCK_INTERVAL;
    }
