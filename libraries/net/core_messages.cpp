...
static_assert((int)bts::net::block_message_type == (int)bts::chain::block_message_type, "enum values don't match");
static_assert((int)bts::net::trx_message_type == (int)bts::chain::trx_message_type, "enum values don't match");
